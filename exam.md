...
* __Письменная часть__ проекта загружается накануне дня экзамена в [папку](https://drive.google.com/drive/folders/1fPED_9iUmq1aLDft5VynXpWzaunZKtTN?usp=sharing) в виде файла PDF (объем не менее 2,5 страниц), включает: 
...
5. есть ли другие ресурсы, использующие ту же поисковую корпусную, словарную и т.п. платформу? (как пример, много корпусов используют платформу SketchEngine, Восточно-Армянского корпуса)? легко ли пользователю, освоившему один ресурс, пользоваться другими ресурсами на той же платформе? в чем отличия?  
